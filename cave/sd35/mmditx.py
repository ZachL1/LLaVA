...
class MMDiTX(nn.Module):
    ...
    def __init__(
        ...
        patch_size: int = 2,
        in_channels: int = 4,
        hidden_size: Optional[int] = None,  # Add hidden_size parameter
        depth: int = 28,
        mlp_ratio: float = 4.0,
        ...
        # Use provided hidden_size or apply magic --> this defines a head_size of 64
        if hidden_size is not None:
            hidden_size = hidden_size
            num_heads = hidden_size // 64  # Maintain head_size of 64
        else:
    ...
    def forward(
        ...
        _, x = self.forward_core_with_concat(x, c, context, skip_layers, controlnet_hidden_states)
